...
model.add(eval(args.conv_layer_type)(int(48*args.layers_scaling), kernel_size=(3, 3), padding='same', activation='relu'))
...
model.add(eval(args.conv_layer_type)(int(24*args.layers_scaling), kernel_size=(3, 3), padding='same', activation='relu'))
model.add(MaxPool2D(pool_size=(2, 2)))
model.add(Flatten())
model.add(Dropout(0.25))
model.add(Dense(int(256*args.layers_scaling), activation='relu'))
model.add(Dropout(0.25))
