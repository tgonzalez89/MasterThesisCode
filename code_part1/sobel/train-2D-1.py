    ...
    while True:
        ...
        for epoch in range(1000):
            ...
            if history.history['loss'][0] >= 0.15:
                ...
                break
            if epoch >= 25 and history.history['loss'][0] >= 0.01:
                print("Not converging fast enough. Trying again...")
                break
            if epoch >= 50 and history.history['loss'][0] >= 0.009:
                print("Not converging fast enough. Trying again...")
                break
            if epoch >= 100 and history.history['loss'][0] >= 0.008:
                print("Not converging fast enough. Trying again...")
                break
            ...
            if history.history['loss'][0] < 0.0025:
                ...
                break'''
        if history.history['loss'][0] < 0.007:
            break
