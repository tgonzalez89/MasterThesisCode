...
try:
    while True:
        ...
        for epoch in range(128):
            ...
            if epoch >= 7 and history.history['mean_absolute_percentage_error'][0] >= 4:
                print("Starting weights/biases not good. Trying again...")
                break
            if epoch >= 31 and history.history['mean_absolute_percentage_error'][0] >= 3:
