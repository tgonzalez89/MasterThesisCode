    ...
    while True:
        ...
        for epoch in range(1000):
            ...
            if history.history['loss'][0] >= 0.02:
                ...
                break
            if epoch >= 25 and history.history['loss'][0] >= 0.005:
                print("Not converging fast enough. Trying again...")
                break
            if epoch >= 100 and history.history['loss'][0] >= 0.0025:
                print("Not converging fast enough. Trying again...")
                break
            if epoch >= 500 and history.history['loss'][0] >= 0.002:
                print("Not converging fast enough. Trying again...")
                break
...
model.save("nn_inversek2j-2D-1.h5")
