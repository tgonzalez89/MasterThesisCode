    ...
    while True:
        ...
        for epoch in range(128):
            ...
            if history.history['loss'][0] >= 0.01:
                ...
                break
            if epoch >= 3 and history.history['loss'][0] >= 0.004:
                print("Not converging fast enough. Trying again...")
                break
            if epoch >= 7 and history.history['loss'][0] >= 0.002:
                print("Not converging fast enough. Trying again...")
                break
            if epoch >= 15 and history.history['loss'][0] >= 0.001:
                print("Not converging fast enough. Trying again...")
                break
...
model.save("nn_inversek2j-2D.h5")
