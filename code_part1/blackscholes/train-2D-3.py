...
try:
    while True:
        model = Sequential()
        model.add(Conv2D(20, (1,in_size), strides=(1,in_size), padding='valid', activation='relu', input_shape=inputs.shape[1:]))
        model.add(Conv2D(20, (1,1), strides=(1,1), padding='valid', activation='relu'))
        model.add(Conv2D(20, (1,1), strides=(1,1), padding='valid', activation='relu'))
...
model.save("nn_blackscholes-2D-3.h5")
