...
int main (int argc, char* argv[]) {
    ...
    InferenceEngine::CNNNetwork network = core.ReadNetwork("nn_blackscholes-2D.xml", "nn_blackscholes-2D.bin");
    ...
    const int BLOCK_SIZE = input_data->getTensorDesc().getDims().at(2) * (input_data->getTensorDesc().getDims().at(3) / 6);
