...
try:
    while True:
        model = Sequential()
        model.add(Conv2D(64, (1,in_size), strides=(1,in_size), padding='valid', activation='relu', input_shape=inputs.shape[1:]))
        model.add(Conv2D(32, (1,1), strides=(1,1), padding='valid', activation='relu'))
        ...
        for epoch in range(1024):
            ...
            if history.history['binary_accuracy'][0] <= 0.75:
                ...
                break
            if epoch >= 15 and history.history['binary_accuracy'][0] <= 0.8:
            ...
            if history.history['binary_accuracy'][0] > 0.9:
                ...
                break
        if history.history['binary_accuracy'][0] > 0.89:
            break
